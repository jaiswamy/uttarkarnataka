 ...
 * @since      1.0.0
 */
class Newspaper_Ads125_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newspaper-ad125 widget_125',
			'description' => __( 'Easily to display any type of ad.', 'newspaper' )
		);

		// Create the widget.
		parent::__construct(
			'newspaper-ad125',                                  // $this->id_base
			__( '&raquo; Advertisement 125x125', 'newspaper' ), // $this->name
