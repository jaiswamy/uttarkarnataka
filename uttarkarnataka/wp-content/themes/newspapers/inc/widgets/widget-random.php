 ...
 * @since      1.0.0
 */
class Newspaper_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newspaper-random posts-thumbnail-widget',
			'description' => __( 'Display random posts with thumbnails.', 'newspaper' )
		);

		// Create the widget.
		parent::__construct(
			'newspaper-random',                                   // $this->id_base
			__( '&raquo; Random Posts Thumbnails', 'newspaper' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'newspaper' ),
			'limit'     => 5,
			'show_date' => false
		);
