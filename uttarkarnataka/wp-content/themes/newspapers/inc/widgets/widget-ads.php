 ...
 * @since      1.0.0
 */
class Newspaper_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newspaper-ad widget_ads',
			'description' => __( 'Easily to display any type of ad.', 'newspaper' )
		);

		// Create the widget.
		parent::__construct(
			'newspaper-ads',                            // $this->id_base
			__( '&raquo; Advertisement', 'newspaper' ), // $this->name
