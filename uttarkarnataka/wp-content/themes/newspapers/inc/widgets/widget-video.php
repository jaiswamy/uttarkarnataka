 ...
 * @since      1.0.0
 */
class Newspaper_Video_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-newspaper-video video-widget',
			'description' => __( 'Easily to display any type of video.', 'newspaper' )
		);

		// Create the widget.
		parent::__construct(
			'newspaper-video',                  // $this->id_base
			__( '&raquo; Video', 'newspaper' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Video', 'newspaper' ),
			'video_url'  => '',
			'video_code' => ''
		);
