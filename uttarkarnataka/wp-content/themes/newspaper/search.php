	...
	<main id="main" class="site-main clearfix column" role="main" <?php hybrid_attr( 'content' ); ?>>
		<div id="primary" class="content-area column">
			...
			<header class="page-header">
				<h1 class="section-title"><span class="heading-text"><?php printf( __( 'Search Results for: %s', 'newspaper' ), '<span>' . get_search_query() . '</span>' ); ?></span></h1>
			</header><!-- .page-header -->
			...
			<div id="content" class="content-loop <?php echo esc_attr( newspaper_posts_layout() ); ?> column">
				...
				<?php if ( have_posts() ) : ?>
					...
					<?php $i = 1; ?>
					<?php $layout = of_get_option( 'newspaper_search_layout', 'list' ); ?>
