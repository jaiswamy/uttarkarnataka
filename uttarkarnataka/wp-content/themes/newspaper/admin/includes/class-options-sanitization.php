...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'newspaper' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'newspaper' ),
		'repeat-y'  => __( 'Repeat Vertically', 'newspaper' ),
		'repeat'    => __( 'Repeat All', 'newspaper' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'newspaper' ),
		'top center'    => __( 'Top Center', 'newspaper' ),
		'top right'     => __( 'Top Right', 'newspaper' ),
		'center left'   => __( 'Middle Left', 'newspaper' ),
		'center center' => __( 'Middle Center', 'newspaper' ),
		'center right'  => __( 'Middle Right', 'newspaper' ),
		'bottom left'   => __( 'Bottom Left', 'newspaper' ),
		'bottom center' => __( 'Bottom Center', 'newspaper' ),
		'bottom right'  => __( 'Bottom Right', 'newspaper')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'newspaper' ),
		'fixed'  => __( 'Fixed in Place', 'newspaper')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'newspaper' ),
		'italic'      => __( 'Italic', 'newspaper' ),
		'bold'        => __( 'Bold', 'newspaper' ),
		'bold italic' => __( 'Bold Italic', 'newspaper' )
		);
